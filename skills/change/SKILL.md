...
- `authority: {paths, commands, allowLocalCommit, ...budgets}`
...
- A failed check, exhausted budget, stale approval or unavailable reviewer is not success. Explain the recorded exception; do not reset counters or silently widen permission.
